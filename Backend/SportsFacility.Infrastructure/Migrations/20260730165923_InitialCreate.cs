        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionPlans_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSchedules_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QREntryCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserMemberships_SubscriptionPlans_SubscriptionPlanId",
            ...
            migrationBuilder.CreateTable(
                name: "UserMembershipDependents",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserMembershipId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DependentUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMembershipDependents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMembershipDependents_UserMemberships_UserMembershipId",
                        column: x => x.UserMembershipId,
                        principalTable: "UserMemberships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserMembershipDependents_Users_DependentUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_FacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_FacilityId",
                table: "SubscriptionPlans",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMembershipDependents_DependentUserId",
                table: "UserMembershipDependents",
                column: "DependentUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMembershipDependents_UserMembershipId",
                table: "UserMembershipDependents",
                column: "UserMembershipId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMemberships_SubscriptionPlanId",
